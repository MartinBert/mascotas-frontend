...
const calculateLineTotal = (line) => {
    const totalWithoutModifications = line.productoPrecioUnitario * line.cantidadUnidades;
    ...
    switch (action.type) {
        ...
        case actions.SET_VOUCHER_NUMBERS:
            return {
                ...
                numeroCompletoFactura: completeLengthWithZero(state.puntoVentaNumero, 4) + '-' + completeLengthWithZero(action.payload, 8)
            }
